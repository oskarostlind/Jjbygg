...
export function Stepper({ currentStep, className }: StepperProps) {
  ...
  return (
    <nav aria-label="Steg i formuläret" className={cn("flex items-center justify-center gap-2", className)}>
            ...
            <div className="flex flex-col items-center">
              <div
                className={cn(
                  ...
                  !isActive && !isCompleted && "border-primary/30 bg-background text-muted-foreground"
                )}
